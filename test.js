...
(() => {
  ...
  var b = class extends HTMLElement {
    ...
    addController(t4) {
      (this._$E_ ?? (this._$E_ = /* @__PURE__ */ new Set())).add(t4), void 0 !== this.renderRoot && this.isConnected && t4.hostConnected?.();
    }
    removeController(t4) {
      this._$E_?.delete(t4);
    }
    ...
    connectedCallback() {
      this.renderRoot ?? (this.renderRoot = this.createRenderRoot()), this.enableUpdating(true), this._$E_?.forEach((t4) => t4.hostConnected?.());
    }
    enableUpdating(t4) {
    }
    ...
    requestUpdate(t4, s4, i4) {
      if (void 0 !== t4) {
        if (i4 ?? (i4 = this.constructor.getPropertyOptions(t4)), !(i4.hasChanged ?? f)(this[t4], s4))
          return;
        this.C(t4, s4, i4);
      }
    ...
    C(t4, s4, i4) {
      this._$AL.has(t4) || this._$AL.set(t4, s4), true === i4.reflect && this._$Em !== t4 && (this._$ET ?? (this._$ET = /* @__PURE__ */ new Set())).add(t4);
    }
    async _$EP() {
    ...
    update(t4) {
      this._$ET && (this._$ET = this._$ET.forEach((t5) => this._$EO(t5, this[t5]))), this._$Ej();
    }
    updated(t4) {
    }
    firstUpdated(t4) {
  ...
  b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[d("elementProperties")] = /* @__PURE__ */ new Map(), b[d("finalized")] = /* @__PURE__ */ new Map(), p?.({ ReactiveElement: b }), (a.reactiveElementVersions ?? (a.reactiveElementVersions = [])).push("2.0.3");
...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  function N(t4, i4, s4 = t4, e5) {
    ...
    return h3?.constructor !== o4 && (h3?._$AO?.(false), void 0 === o4 ? h3 = void 0 : (h3 = new o4(t4), h3._$AT(t4, s4, e5)), void 0 !== e5 ? (s4._$Co ?? (s4._$Co = []))[e5] = h3 : s4._$Cl = h3), void 0 !== h3 && (i4 = N(t4, h3._$AS(t4, i4.values), h3, e5)), i4;
  }
  var S2 = class {
    constructor(t4, i4) {
    ...
    _$AI(t4, i4 = this, s4, e5) {
      ...
      if (void 0 === h3)
        ...
        for (t4 = h3[0], n5 = 0; n5 < h3.length - 1; n5++)
          r5 = N(this, e6[s4 + n5], i4, n5), r5 === w && (r5 = this._$AH[n5]), o4 || (o4 = !c3(r5) || r5 !== this._$AH[n5]), r5 === T ? t4 = T : t4 !== T && (t4 += (r5 ?? "") + h3[n5 + 1]), this._$AH[n5] = r5;
      }
      o4 && !e5 && this.O(t4);
    }
    O(t4) {
  ...
  Z?.(V, M), (t2.litHtmlVersions ?? (t2.litHtmlVersions = [])).push("3.1.1");
  var j = (t4, i4, s4) => {
  ...
  // component.ts
  var TestComponent = class extends s3 {
    render() {
      return x`Foo, bar.`;
    }
  };
